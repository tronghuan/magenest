...
class Magenest_Vtigerintegration_Model_Sync_Invoice extends Magenest_Vtigerintegration_Model_Connector {
    ...
    public function sync($id) {
        ...
        $customerId = $model->getOrderId();
        $model = Mage::getModel('sales/order')->load($customerId);
        ...
        $model = $this->sendCurlRequest($data, 'Invoice');
        return $model;
    }

    //get fields from to table Invoice Vtiger
    public function getInvoice() {
        $model = $this->getField('Invoice');
        return $model;
    }
